...
"""
dm=DataManager()
dm.set_th_valid("../th_proved.json")
x,labeled_y=dm.create_data("../resultat/geocoq_extract/dependencies/")
res=Reseau()
...
dm=DataManager()
res=Reseau()
res.load("./save_geocoq/")
pm=PredictionManager(dm,res)

th_to_test=json_to_list_or_dict("../th_proved.json")

#seuil_table,acc_table,prop_table=pm.test_multiple_top_k("../resultat/geocoq_extract/dependencies/",th_to_test)
